...
\cdCommand{stop time when temperature below [value]}, the code will iterate
...
specified with the command \cdCommand{stop time $<$value$>$}.
The value given is specified as with the \cdCommand{age} command, Section
\ref{sec:AgeCommand}.
\end{shaded}
