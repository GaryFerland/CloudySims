...
\subsection{Database H2 noise [mean, standard deviation, seed]}
...
As described in \citet{Guzman.I.2016} and \citet{Guzman.II.2016}, we recommend our default option,
...
\citep{Guzman.II.2016}, is used by default.
...
criteria is followed. If no command, standard calculations, with the criteria used in \citet{Guzman.II.2016}, 
...
\subsection{Database [H-like \OR{} He-like] error generation [pessimistic 5]}
...
\begin{verbatim}
database He-like error generation pessimistic 5
\end{verbatim}
...
\subsection{Database He-like FSM}
...
\cdFilename{data/lamda/masterlist}.
