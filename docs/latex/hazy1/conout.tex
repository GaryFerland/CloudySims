...
\subsection{Save arrays levels ``species'' [fits or ppm] [iteration it] [zone nz]}
...
Using this command generates either a FITS or a PPM image, depending on the
keyword given, \cdCommand{fits} or \cdCommand{ppm}.
A FITS image can be viewed and manipulated with standard software (e.g., ds9,
FTOOLS, python, etc.) in post-processing.
