...
\begin{verbatim}
print line sort wavelength range 3500A air to 1.2m air
\end{verbatim}
...
numbers.
This is followed by the vacuum wavelength of the line in microns.
The
line wavelength is then printed in the standard format as it appears in the output.
This may be either an air or vacuum wavelength, depending on whether the
\cdCommand{print line vacuum} command was used.
The log of
...
vacuum wavelengths, all in angstrom.
The first column holds the vacuum wavelength that will be used with reporting
(note that this number will be converted to an air wavelength in the output
unless the \cdCommand{print line vacuum} command is used),
