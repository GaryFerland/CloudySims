...
\subsection{Trace only [keyword]}

This prevents the main trace output from happening.  
The keyword on the line is still parsed and its associated variables are set.
Certain commands will then produce minimal printout.
...
\hline
BeSeq& $^3$P ionization for Be-sequence ions\\
