...
A PPM image of the same data will be generated instead, if the keyword
\cdCommand{image} appears on the command.
A FITS image will be generated instead of a PPM image, if the keyword
\cdCommand{FITS} also appears.
Either way, the image will be generated for the given species for all
iterations and zones.
