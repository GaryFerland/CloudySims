...
\cdCommand{save line intensities} command instead.} This controls details of that printout. Note that each option is intended to be used as a standalone command. If multiple options are required, they should be specified on separate lines to ensure proper execution.
