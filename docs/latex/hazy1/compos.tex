...
You should use one of these \cdCommand{metals deplete} commands, or specify
...
one of the \cdFilename{*.dep} files located in the
...
\end{verbatim}
The default file that is read if no name is specified is documented in the \cdFilename{readme.md}
...
This command includes a \cdCommand{print} keyword that will  report
...
The \cdFilename{readme.md} file in the \cdFilename{abundances} directory
