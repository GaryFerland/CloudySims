...
turns on a large (and slow) model of \htwo\ \citep{ShawEtAl05} emission.
...
For plot formatting, chose no line (set line color to while) and use a symbol for the points.
