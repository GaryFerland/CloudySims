...
using the contents of the file \cdFilename{continuum\_mesh.dat}. Each of these
...
The file \cdFilename{continuum\_mesh.dat} contains ordered pairs of continuum
...
contents of \cdFilename{continuum\_mesh.dat} to change the resolution of the
...
resolution in each section defined in \cdFilename{continuum\_mesh.dat}. This
