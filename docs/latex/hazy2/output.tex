...
Two charge states are listed per line. First the index number for the charge state is given,
followed by the charge in elementary charge units. Next come the fractional population
of this charge state and the temperature of this grain in kelvin.
These populations add up to 1 for all charge states of a given size bin.
