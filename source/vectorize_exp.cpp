...
inline v8df v1expd(v8df x)
{
	...
	if( ! _mm512_kortestz(invalid, invalid) )
		throw domain_error( DEMsg("v1expd", x, invalid) );
...
inline v8df v1exp10d(v8df x)
{
	...
	if( ! _mm512_kortestz(invalid, invalid) )
		throw domain_error( DEMsg("v1exp10d", x, invalid) );
...
inline v8df v1expm1d(v8df x)
{
	...
	if( ! _mm512_kortestz(invalid, invalid) )
		throw domain_error( DEMsg("v1expm1d", x, invalid) );
...
inline v16sf v1expf(v16sf x)
{
	...
	if( ! _mm512_kortestz(invalid, invalid) )
		throw domain_error( DEMsg("v1expf", x, invalid) );
...
inline v16sf v1exp10f(v16sf x)
{
	...
	if( ! _mm512_kortestz(invalid, invalid) )
		throw domain_error( DEMsg("v1exp10f", x, invalid) );
...
inline v16sf v1expm1f(v16sf x)
{
	...
	if( ! _mm512_kortestz(invalid, invalid) )
		throw domain_error( DEMsg("v1expm1f", x, invalid) );
