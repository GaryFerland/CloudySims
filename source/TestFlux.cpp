...
namespace {
	...
	TEST(TestFluxCTor)
	{
		...
		CHECK( fp_equal( Ferg_s_cm2_A.get(), E.angstromVac() ) );
		Flux Ferg_s_cm2_micron(E,1.,"erg/s/cm2/micron");
		CHECK( fp_equal( Ferg_s_cm2_micron.get(), E.micronVac() ) );
		...
		CHECK( fp_equal( FW_m2_A.get(), 1.e3*E.angstromVac() ) );
		Flux FW_m2_nm(E,1.,"W/m2/nm");
		CHECK( fp_equal( FW_m2_nm.get(), 1.e3*E.nmVac() ) );
		Flux FW_m2_micron(E,1.,"W/m2/micron");
		CHECK( fp_equal( FW_m2_micron.get(), 1.e3*E.micronVac() ) );
		...
		CHECK( fp_equal( FW_cm2_A.get(), 1.e7*E.angstromVac() ) );
		Flux FW_cm2_micron(E,1.,"W/cm2/micron");
		CHECK( fp_equal( FW_cm2_micron.get(), 1.e7*E.micronVac() ) );
	...
	TEST(TestFluxSet)
	{
		...
		CHECK( fp_equal( F.get(), 10.*E.angstromVac() ) );
		CHECK_EQUAL( "erg/s/cm2/A", F.uu() );

		F.set(E,10.,"erg/s/cm2/micron");
		CHECK( fp_equal( F.get(), 10.*E.micronVac() ) );
		...
		F.set(E,10.,"W/m2/A");
		CHECK( fp_equal( F.get(), 1.e4*E.angstromVac() ) );
		CHECK_EQUAL( "W/m2/A", F.uu() );

		F.set(E,10.,"W/m2/nm");
		CHECK( fp_equal( F.get(), 1.e4*E.nmVac() ) );
		CHECK_EQUAL( "W/m2/nm", F.uu() );

		F.set(E,10.,"W/m2/micron");
		CHECK( fp_equal( F.get(), 1.e4*E.micronVac() ) );
		...
		F.set(E,10.,"W/cm2/A");
		CHECK( fp_equal( F.get(), 1.e8*E.angstromVac() ) );
		CHECK_EQUAL( "W/cm2/A", F.uu() );

		F.set(E,10.,"W/cm2/micron");
		CHECK( fp_equal( F.get(), 1.e8*E.micronVac() ) );
	...
	TEST(TestFluxGet)
	{
		...
		CHECK( fp_equal( F.get("erg/s/cm2/A"), 1./E.angstromVac() ) );
		CHECK( fp_equal( F.get("erg/s/cm2/micron"), 1./E.micronVac() ) );
		CHECK( fp_equal( F.get("erg/s/cm2/Hz"), 1./E.Hz() ) );
		CHECK( fp_equal( F.get("W/m2"), 1.e-3 ) );
		CHECK( fp_equal( F.get("W/m2/A"), 1.e-3/E.angstromVac() ) );
		CHECK( fp_equal( F.get("W/m2/micron"), 1.e-3/E.micronVac() ) );
		CHECK( fp_equal( F.get("W/m2/Hz"), 1.e-3/E.Hz() ) );
		CHECK( fp_equal( F.get("W/cm2"), 1.e-7 ) );
		CHECK( fp_equal( F.get("W/cm2/A"), 1.e-7/E.angstromVac() ) );
		CHECK( fp_equal( F.get("W/cm2/nm"), 1.e-7/E.nmVac() ) );
		CHECK( fp_equal( F.get("W/cm2/micron"), 1.e-7/E.micronVac() ) );
	...
	TEST(TestFluxUnitConversion)
	{
		...
		CHECK( fp_equal( F.get( StandardFluxUnit("ERG/S/SQCM/A ") ), 10./F.E().angstromVac() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("ERG/S/SQCM/MICRON") ), 10./F.E().micronVac() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("ERG/S/SQCM/HZ") ), 10./F.E().Hz() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQM") ), 1.e-2 ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQM/A ") ), 1.e-2/F.E().angstromVac() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQM/MICRON") ), 1.e-2/F.E().micronVac() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQM/HZ") ), 1.e-2/F.E().Hz() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQCM") ), 1.e-6 ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQCM/A ") ), 1.e-6/F.E().angstromVac() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQCM/MICRON") ), 1.e-6/F.E().micronVac() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQCM/HZ") ), 1.e-6/F.E().Hz() ) );
		CHECK( fp_equal( F.get( StandardFluxUnit("W/SQCM/NM/SR") ), 1.e-6/F.E().nmVac()/PI4 ) );
