...
inline v8df v1sqrtd(v8df x)
{
	...
	if( ! _mm512_kortestz(invalid1, invalid2) )
	{
		...
		throw domain_error( DEMsg("v1sqrtd", x, invalid) );
	}
...
inline v8df v1hypotd(v8df x, v8df y)
{
	...
	if( ! _mm512_kortestz(invalid1, invalid2) )
		throw domain_error( DEMsg("v1hypotd", x, invalid1, y, invalid2) );
...
inline v16sf v1sqrtf(v16sf x)
{
	...
	if( ! _mm512_kortestz(invalid1, invalid2) )
	{
		...
		throw domain_error( DEMsg("v1sqrtf", x, invalid) );
	}
...
inline v16sf v1hypotf(v16sf x, v16sf y)
{
	...
	if( ! _mm512_kortestz(invalid1, invalid2) )
		throw domain_error( DEMsg("v1hypotf", x, invalid1, y, invalid2) );
