...
void t_iterations::alloc()
{
	...
	iter_malloc = 200;
	IterPrnt.resize((size_t)iter_malloc);
	nend.resize( (size_t)iter_malloc);
	StopThickness.resize((size_t)iter_malloc);
	StopRadius.resize((size_t)iter_malloc);
}
