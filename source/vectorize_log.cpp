...
inline v8df v1logd(v8df x)
{
	...
	if( ! _mm512_kortestz(invalid1, invalid2) )
	{
		...
		throw domain_error( DEMsg("v1logd", x, invalid) );
	}
...
inline v8df v1log10d(v8df x)
{
	...
	{
		__mmask8 invalid = invalid1 | invalid2;
		throw domain_error( DEMsg("v1log10d", x, invalid) );
	}
	x = v1logd_core(x);
...
inline v8df v1log1pd(v8df x)
{
	...
	{
		__mmask8 invalid = invalid1 | invalid2;
		throw domain_error( DEMsg("v1log1pd", x, invalid) );
	}
...
inline v16sf v1logf(v16sf x)
{
	...
	if( ! _mm512_kortestz(invalid1, invalid2) )
	{
		...
		throw domain_error( DEMsg("v1logf", x, invalid) );
	}
...
inline v16sf v1log10f(v16sf x)
{
	...
	{
		__mmask16 invalid = invalid1 | invalid2;
		throw domain_error( DEMsg("v1log10f", x, invalid) );
	}
	x = v1logf_core(x);
...
inline v16sf v1log1pf(v16sf x)
{
	...
	{
		__mmask16 invalid = invalid1 | invalid2;
		throw domain_error( DEMsg("v1log1pf", x, invalid) );
	}
