...
/** following is a limit to how many levels can be computed for
 * model hydrogen atom fit on radiative recombination - this has the one extra included, so at most
